  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-[#36454f]/90 backdrop-blur-xl border border-[#b9b2aa]/20 rounded-2xl shadow-2xl p-3">
                      ...
                      >
                        <IconComponent 
                          className={`h-5 w-5 transition-colors duration-300 ${
                            hoveredIndex === index 
                              ? "text-[#007BFF]" 
                              : "text-[#F1F1F1]/70 group-hover:text-[#007BFF]"
                          }`} 
                        />
                        ...
                        <AnimatePresence>
                          {hoveredIndex === index && (
                            <motion.div
                              ...
                              className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 bg-[#36454f] text-[#F1F1F1] px-3 py-1 rounded-lg text-sm font-medium whitespace-nowrap"
                            >
                              {item.name}
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-b-4 border-transparent border-b-[#36454f]" />
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </motion.div>
